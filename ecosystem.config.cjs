// pm2 process manager config - keeps the bot(s) running unattended (auto-restart
...
//
// Add another account: scripts/new-account.sh account3, fill in its .env.account3,
// then add another entry below pointing DOTENV_CONFIG_PATH at that file.
module.exports = {
  apps: [
    {
      name: "perpl-bot-default",
    ...
    // {
    //   name: "perpl-bot-account2",
    //   script: "./node_modules/.bin/tsx",
    //   args: "src/bot.ts",
    //   env: { DOTENV_CONFIG_PATH: ".env.account2" },
    //   autorestart: true,
    //   max_restarts: 50,
    //   restart_delay: 5000,
    // },
